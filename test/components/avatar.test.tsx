...
describe("Avatar Component", () => {
  ...
  it("renders placeholder with initials", () => {
    const { getByText } = render(() => <Avatar placeholder="AB" />);
  ...
  it("supports rounded avatar", () => {
    ...
    expect(container.querySelector(".avatar > div")).toHaveClass(
      "rounded-full",
    );
  });
  ...
  it("renders fallback when image fails to load", () => {
    ...
    const { getByText } = render(() => <Avatar fallback="FB" />);
  ...
  describe("Accessibility", () => {
    ...
    it("includes presence status in aria-label", () => {
      ...
      expect(onlineContainer).toHaveAttribute(
        "aria-label",
        "User Avatar (online)",
      );
      expect(offlineContainer).toHaveAttribute(
        "aria-label",
        "User Avatar (offline)",
      );
    });
  ...
  describe("Edge Cases and Error Handling", () => {
    ...
    it("applies default size when size prop is missing", () => {
      const { container } = render(() => <Avatar placeholder="A" />);
